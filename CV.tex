...
\begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north east] at ($(current page.north east)+(-2cm,-1.2cm)$) {\includegraphics[height=3cm]{Shirley.jpg}};
  \end{tikzpicture}%
...
化学工程与工艺 \quad 大三 
\begin{itemize}[nosep]
    \item 相关课程：《大数据解析及应用导论》、《课程综合实践（HPC101）》、《数据结构基础》、《Python》、《C》
    \item 主修课程核心绩点4.18，专业排名8/103，入选智慧化工卓越培养项目（本博贯通）
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    \item \textbf{软件}：从底层逻辑搭建全连接模型进行Mnist数字识别；利用线性模型进行化学反应速率的预测；使用\textbf{opencv}对溶液变色以及数字黑框进行识别。
    \item \textbf{硬件}：使用\textbf{pymodbus}库进行工业设备通信，控制电机运转和小车运行。
    \item \textbf{核心产出}：，设计了一整套小车运行的方案，并构建了一定的\textbf{可视化操作界面}。
    \item github：https://github.com/Shirley-Sun-222/ZJU-Medical-AI.git
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item github：https://github.com/Shirley-Sun-222/multi-processing-system.git
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item github：https://github.com/Shirley-Sun-222/BigDataAnalysis-Project.git
\end{itemize}
