...
% --- 第二个项目 ---
\textbf{AIGC驱动的超进化自动挖坑机 (Agent)} \hfill 2025.07 -- 2025.08 \titlebreak
...
项目描述：基于工业环境中的警报事件数据集，预测模型目标预测未来每小时的警报数量。
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    \item \textbf{预测模型}：负责\textbf{随机森林}和\textbf{XGBoost}预测模型部分,实现了0.1级别的均方根误差。
